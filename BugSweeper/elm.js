...
var $author$project$Collection$empty = $elm$core$Dict$empty;
...
var $author$project$Bug$generate = function (level) {
	var _v0 = A2(
		$elm$core$List$indexedMap,
		F2(
			function (i, species) {
				return _Utils_Tuple2(
					((A2($elm$core$Basics$pow, i + 1, 2) + (i + 1)) / 2) | 0,
					species);
			}),
		$elm$core$List$reverse(
			A2($elm$core$List$take, level + 1, $author$project$Bug$list)));
	if (_v0.b) {
		var head = _v0.a;
		var tail = _v0.b;
		return A2($elm$random$Random$weighted, head, tail);
	} else {
		return $elm$random$Random$constant($author$project$Bug$Snail);
	}
};
...
var $author$project$Game$Generate$emptyPositions = function (dict) {
	return A2(
...
var $author$project$Game$isValidPos = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return (0 <= x) && ((_Utils_cmp(x, $author$project$Config$gridSize) < 0) && ((0 <= y) && (_Utils_cmp(y, $author$project$Config$gridSize) < 0)));
};
var $author$project$Game$neighborsOf = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$core$List$filter,
		$author$project$Game$isValidPos,
		_List_fromArray(
			[
				_Utils_Tuple2(x + 1, y),
				_Utils_Tuple2(x - 1, y),
...
var $author$project$Game$Generate$ensureAtLeast = F4(
	function (n, block, pos, dict) {
		var remaining = n - $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (p) {
					return _Utils_eq(
				...
				$author$project$Game$neighborsOf(pos)));
		return A2(
			$elm$random$Random$map,
			function (_v0) {
				var l = _v0.a;
				return A3(
					$elm$core$List$foldl,
					function (p) {
						return A2($elm$core$Dict$insert, p, block);
					},
					dict,
					l);
			},
			A2(
				...
				A2(
					$elm$core$List$filter,
					function (p) {
						return !A2($elm$core$Dict$member, p, dict);
					},
					$author$project$Game$neighborsOf(pos))));
	});
...
var $author$project$Game$Generate$pick = function (list) {
	if (list.b) {
		var head = list.a;
		var tail = list.b;
		return $elm$core$Maybe$Just(
...
var $author$project$Game$Generate$placeBug = F2(
	function (bug, dict) {
		var requirements = $author$project$Bug$requirementsOf(bug);
		return A2(
					...
					function (pos) {
						return A2(
							...
							A2(
								...
								pos,
								$author$project$Game$Generate$BugBlock(bug)),
							A3(
								$elm$core$List$foldl,
								function (_v4) {
									var n = _v4.a;
									...
									return $elm$random$Random$andThen(
										A3(
											$author$project$Game$Generate$ensureAtLeast,
											n,
											A2(
												$elm$core$Maybe$withDefault,
												$author$project$Game$Generate$EmptyBlock,
												A2($elm$core$Maybe$map, $author$project$Game$Generate$ObjectBlock, block)),
											pos));
								},
								$elm$random$Random$constant(dict),
								requirements));
					}),
				$author$project$Game$Generate$pick(
					A2(
						$elm$core$List$filter,
						function (pos) {
							var neighbors = A2(
							...
							var requirementsAreMet = A2(
									...
									return _Utils_cmp(
										...
										$elm$core$List$length(
											A2(
												...
												function (_v3) {
													var maybe = _v3.b;
													return _Utils_eq(maybe, $elm$core$Maybe$Nothing) || _Utils_eq(
														maybe,
														$elm$core$Maybe$Just(
															A2(
																$elm$core$Maybe$withDefault,
								...
								requirements);
							var enoughSpace = _Utils_cmp(
								$elm$core$List$sum(
									A2($elm$core$List$map, $elm$core$Tuple$first, requirements)),
								$elm$core$List$length(
									A2(
										$elm$core$List$filter,
										function (_v0) {
															...
															function (_v1) {
																...
																return _Utils_eq(
																	...
																	A2(
																		$elm$core$Maybe$withDefault,
																		$author$project$Game$Generate$EmptyBlock,
																		A2($elm$core$Maybe$map, $author$project$Game$Generate$ObjectBlock, maybeTile)));
															},
															requirements);
													},
													maybe));
										...
										neighbors))) < 1;
							return requirementsAreMet && enoughSpace;
						},
						$author$project$Game$Generate$emptyPositions(dict)))));
	});
var $author$project$Game$Generate$placeEmpty = function (dict) {
	var _v0 = $author$project$Game$Generate$emptyPositions(dict);
	if (_v0.b) {
		var head = _v0.a;
		var tail = _v0.b;
		return A2(
			$elm$random$Random$map,
			function (pos) {
				return A3($elm$core$Dict$insert, pos, $author$project$Game$Generate$EmptyBlock, dict);
			},
			A2($elm$random$Random$uniform, head, tail));
	} else {
		return $elm$random$Random$constant(dict);
	}
};
var $author$project$Game$Generate$placeTile = F2(
	function (tile, game) {
		var _v0 = $author$project$Game$Generate$emptyPositions(game);
		if (_v0.b) {
			var head = _v0.a;
			var tail = _v0.b;
			return A2(
				...
				function (pos) {
					return A3(
						$elm$core$Dict$insert,
						pos,
						$author$project$Game$Generate$ObjectBlock(tile),
						game);
				},
				A2($elm$random$Random$uniform, head, tail));
		} else {
...
var $author$project$Game$Generate$place = function (block) {
	switch (block.$) {
		case 'ObjectBlock':
			var tile = block.a;
			return $author$project$Game$Generate$placeTile(tile);
		case 'BugBlock':
			var bug = block.a;
			return $author$project$Game$Generate$placeBug(bug);
		default:
			return $author$project$Game$Generate$placeEmpty;
	}
};
var $author$project$Game$BugTile = function (a) {
	return {$: 'BugTile', a: a};
};
var $author$project$Game$placeBug = F3(
	function (pos, bug, game) {
		return _Utils_update(
			game,
			{
				tiles: A3(
					$elm$core$Dict$insert,
					pos,
					$author$project$Game$BugTile(bug),
					game.tiles)
			});
	});
var $author$project$Game$ObjectTile = function (a) {
	return {$: 'ObjectTile', a: a};
};
var $author$project$Game$placeObject = F3(
		...
		return _Utils_update(
			game,
			{
				tiles: A3(
					$elm$core$Dict$insert,
					pos,
					$author$project$Game$ObjectTile(tile),
					game.tiles)
			});
	});
...
var $author$project$Collection$Cute = {$: 'Cute'};
var $author$project$Main$OpenOverlay = function (a) {
	return {$: 'OpenOverlay', a: a};
};
var $author$project$Collection$Royal = {$: 'Royal'};
...
var $author$project$Collection$variantToString = function (variant) {
	if (variant.$ === 'Cute') {
		return 'Cute';
	} else {
		return 'Royal';
...
var $author$project$Collection$add = F2(
	function (c1, c2) {
		return A3(
			$elm$core$Dict$foldl,
			F3(
				function (_v0, entry, c) {
					return A3(
						$elm$core$Dict$foldl,
						F2(
	...
	return (game.remainingGuesses <= 0) || $elm$core$Dict$isEmpty(
		A2(
			...
			F2(
				function (pos, tile) {
					if (tile.$ === 'BugTile') {
						return !A2($elm$core$Dict$member, pos, game.revealed);
					} else {
						return false;
					}
				}),
...
var $author$project$Game$reveal = F3(
	function (pos, variant, game) {
		return _Utils_update(
			game,
			{
				collected: function () {
				...
				remainingGuesses: _Utils_eq(
					A2($elm$core$Dict$get, pos, game.tiles),
					$elm$core$Maybe$Nothing) ? (game.remainingGuesses - 1) : game.remainingGuesses,
				revealed: A3($elm$core$Dict$insert, pos, variant, game.revealed)
			});
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'TileClicked':
				var pos = msg.a;
				return $author$project$Game$isOver(model.game) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : function (_v2) {
					var variant = _v2.a;
					var newSeed = _v2.b;
					...
					A2(
						...
						A2(
							$elm$random$Random$weighted,
							_Utils_Tuple2(1, $author$project$Collection$Royal),
							_List_fromArray(
								[
									_Utils_Tuple2(19, $author$project$Collection$Cute)
								])),
						model.seed));
			case 'SelectBugSpecies':
				var bug = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							overlay: $elm$core$Maybe$Just(
								$author$project$Main$Collection(
...
var $author$project$Main$SelectBugSpecies = function (a) {
	return {$: 'SelectBugSpecies', a: a};
};
...
var $author$project$View$Square$revealedAndSpecialCaptured = F2(
	function (attrs, string) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				$author$project$View$Square$asAttrs,
				_Utils_ap(
					_List_fromArray(
						[
...
var $author$project$Object$toString = function (tile) {
	switch (tile.$) {
		case 'Stone':
			return '🪨';
		case 'Leaf':
...
var $author$project$View$Game$tile = F3(
	function (attrs, _v0, game) {
		...
		var string = function () {
			if (revealed) {
				if (currentTile.$ === 'Just') {
					if (currentTile.a.$ === 'ObjectTile') {
						var object = currentTile.a.a;
						return $author$project$Object$toString(object);
					} else {
						var bug = currentTile.a.a;
						return $author$project$Bug$toString(bug);
					}
				} else {
					return '❌';
				}
		...
		return function () {
			if (revealed) {
				if ((currentTile.$ === 'Just') && (currentTile.a.$ === 'BugTile')) {
					var _v2 = A2(
						$elm$core$Dict$get,
						_Utils_Tuple2(x, y),
						game.revealed);
					if ((_v2.$ === 'Just') && (_v2.a.$ === 'Royal')) {
						var _v3 = _v2.a;
						return $author$project$View$Square$revealedAndSpecialCaptured(attrs);
					} else {
						return $author$project$View$Square$revealedAndCaptured(attrs);
					}
				} else {
					return $author$project$View$Square$revealed(attrs);
				}
			} else {
				return $author$project$View$Square$default(attrs);
			}
		}()(string);
	});
				...
				function (y) {
					return A2(
						...
						A2(
							...
							function (x) {
								return A3(
									$author$project$View$Game$tile,
									A2(
										$elm$core$Dict$member,
										_Utils_Tuple2(x, y),
										game.revealed) ? _List_Nil : $Orasund$elm_layout$Layout$asButton(
										{
											label: 'Reveal ' + ($elm$core$String$fromInt(x) + (',' + $elm$core$String$fromInt(y))),
...
var $author$project$View$Collection$closedCollection = F3(
	function (attrs, args, collectedBugs) {
		return A2(
			$author$project$View$Collection$drawer,
			_Utils_ap(
				_List_fromArray(
					[
...
var $author$project$View$Collection$detailCard = function (bug) {
	return A2(
...
var $author$project$View$Bubble$button = F2(
	function (attrs, args) {
		return $author$project$View$Bubble$default(
			_Utils_ap(
...
var $author$project$View$Collection$openCollection = F3(
	function (attrs, args, collectedBugs) {
		return A2(
			$author$project$View$Collection$drawer,
			_Utils_ap(
					...
					A2(
						...
						function (species) {
							...
							if (!_v0.b) {
								...
								var list = _v0;
								return A2($elm$core$List$member, $author$project$Collection$Royal, list) ? A3(
									$author$project$View$Bubble$specialButton,
									_List_Nil,
									{
										label: 'View details of ' + $author$project$Bug$toString(species),
										onPress: $elm$core$Maybe$Just(
											args.onSelect(species))
									},
									$author$project$Bug$toString(species)) : A3(
									$author$project$View$Bubble$button,
									_List_Nil,
									{
										label: 'View details of ' + $author$project$Bug$toString(species),
										onPress: $elm$core$Maybe$Just(
...
var $author$project$Color$primary = '#75cc81';
...
var $author$project$View$Bubble$newAndSpecial = F2(
	function (attrs, string) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
...
var $author$project$View$Bubble$special = F2(
	function (attrs, string) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
...
var $author$project$View$Summary$toHtml = function (args) {
	var _v0 = A2(
		$elm$core$List$partition,
		function (_v3) {
			var pos = _v3.a;
			return A2($elm$core$Dict$member, pos, args.revealed);
		},
		A2(
			...
			function (_v1) {
				...
				if (tile.$ === 'BugTile') {
					var bug = tile.a;
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(pos, bug));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			},
			$elm$core$Dict$toList(args.tiles)));
					...
					[
						...
						A2(
							...
							function (_v7) {
								...
								var l = _v7.b;
								return function () {
									if (A2($author$project$Collection$member, bug, args.oldCollection)) {
										if (variant.$ === 'Cute') {
											return $author$project$View$Bubble$default(_List_Nil);
										} else {
											return $author$project$View$Bubble$special(_List_Nil);
										}
									} else {
										if (variant.$ === 'Cute') {
											return $author$project$View$Bubble$new(_List_Nil);
										} else {
											return $author$project$View$Bubble$newAndSpecial(_List_Nil);
										}
									}
								}()(
									$elm$core$String$concat(
							...
							A2(
								...
								function (_v5) {
									...
									return _Utils_Tuple3(
										A2($author$project$Collection$member, bug, args.oldCollection) ? 1 : 0,
										$author$project$Collection$variantToString(variant),
								...
								$elm_community$list_extra$List$Extra$gatherEquals(
									A2(
										...
										function (_v4) {
											...
											return A2(
												$elm$core$Maybe$map,
												$elm$core$Tuple$pair(bug),
												A2($elm$core$Dict$get, pos, args.revealed));
										},
										revealedBugs)))))
					])),
				A2(
					...
					[
						...
						A2(
							...
							A2(
								...
								$elm_community$list_extra$List$Extra$gatherEquals(
									A2($elm$core$List$map, $elm$core$Tuple$second, missedBugs)))))
					]))
			]));
};
									...
									$elm$core$String$concat(
										$elm$core$List$sort(
											A2(
												$elm$core$List$map,
												function (bug) {
													return A2($author$project$Collection$member, bug, model.oldCollection) ? $author$project$Bug$toString(bug) : '❓';
												},
												A2(
													$elm$core$List$filterMap,
													function (_v0) {
														...
														if (tile.$ === 'BugTile') {
															var bug = tile.a;
															return A2($elm$core$Dict$member, pos, model.game.revealed) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(bug);
														} else {
															return $elm$core$Maybe$Nothing;
														}
													},
													$elm$core$Dict$toList(model.game.tiles))))))),
								A2(
								$author$project$View$Game$board,
								...
								if (_v4.a.$ === 'Collection') {
									...
									return _List_fromArray(
										[
											...
											_List_Nil,
											{onSelect: $author$project$Main$SelectBugSpecies, selected: maybeSelected},
											model.oldCollection)
										]);
								} else {
									var _v5 = _v4.a;
