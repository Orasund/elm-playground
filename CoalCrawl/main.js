...
var $author$project$Data$World$insertItemAt = F3(
	function (pos, item, world) {
		return _Utils_update(
			world,
			{
				floor: A3(
...
var $author$project$Data$World$Generation$wallGenerator = function (_v0) {
	...
	return function (list) {
		...
		function (_int) {
			...
			(((y / $author$project$Config$tracksPerTrip) | 0) - (($elm$core$Basics$abs(x) / $author$project$Config$tracksPerTrip) | 0)) + 1));
};
...
var $author$project$Data$Actor$Excavator = function (a) {
	return {$: 'Excavator', a: a};
};
														...
														A3(
															...
															$author$project$Data$Actor$Minecart(
																_Utils_update(
																	minecart,
																	{
																		movedFrom: $elm$core$Maybe$Just(game.player.pos)
																	})),
															game.world)));
											case 'Excavator':
												var excavator = _v3.a.a;
												return $author$project$Data$Effect$withNone(
													function (world) {
														return _Utils_update(
															game,
														...
														A3(
															$author$project$Data$World$setActor,
															id,
															$author$project$Data$Actor$Excavator(
																_Utils_update(
																	excavator,
																	{
																		hasReversed: false,
																		momentum: $elm$core$Maybe$Just(
																			A2($author$project$Data$Position$vecTo, pos, game.player.pos))
																	})),
															game.world)));
											default:
...
var $author$project$Data$Behavior$Minecart$unload = F2(
	function (id, game) {
		...
		if ((_v0.$ === 'Just') && (_v0.a.b.$ === 'Minecart')) {
			var _v1 = _v0.a;
			var pos = _v1.a;
			var wagon = _v1.b.a;
			return (A2(
				$elm$core$List$member,
				$author$project$Data$Game$getTrain(game).pos,
					...
					function (g) {
						return A2(
							...
							A3(
								$author$project$Data$World$setActor,
								id,
								$author$project$Data$Actor$Minecart(m),
								g.world));
					}(
						A2(
							$author$project$Data$Game$setTrainOf,
...
var $author$project$Data$Behavior$Player$putIntoWagon = function (game) {
	var _v0 = A2($author$project$Data$World$getActorAt, game.selected, game.world);
	if ((_v0.$ === 'Just') && (_v0.a.b.$ === 'Minecart')) {
		var _v1 = _v0.a;
		var id = _v1.a;
		var wagon = _v1.b.a;
											...
											A2(
												...
												function (w2) {
													return A3(
														...
														id,
														function (_v3) {
															return $author$project$Data$Actor$Minecart(w2);
														},
														game.world);
												},
												t)));
								},
								A2($author$project$Data$Minecart$insert, item, wagon)));
					},
					$author$project$Data$Player$dropItem(game.player))));
	} else {
		return _Utils_Tuple2(game, _List_Nil);
		...
		A2(
			...
			$author$project$Data$Behavior$Train$move(
				A2(
					$author$project$Data$Game$setTrainOf,
					game,
					$author$project$Data$Train$turnAround(
						A2(
...
var $author$project$Config$excavatorCost = 16;
										...
										function (g) {
											...
											A2(
												...
												A2(
													$author$project$Data$Train$addAll,
													A3(
														$author$project$AnyBag$insert,
														$author$project$Config$excavatorCost,
														$author$project$Data$Item$Iron,
														$author$project$AnyBag$empty($author$project$Data$Item$toString)),
													$author$project$Data$Game$getTrain(game)))))));
						case 'Helper':
							return $elm$core$Maybe$Nothing;
						case 'Train':
...
var $author$project$Data$Behavior$FallingCoal$act = F3(
	function (item, pos, world) {
		return A2(
			$elm$random$Random$map,
			A2(
				$author$project$Data$World$insertEntity,
				$author$project$Data$Entity$Vein(item),
				pos),
			A3(
				$elm$core$List$foldl,
				function (p) {
								...
								A2(
									...
									_List_fromArray(
										[
											...
											$author$project$Data$World$insertActor(
												$author$project$Data$Actor$Helper(
													$author$project$Data$Actor$Falling(item))))
										])));
						});
				},
				$elm$random$Random$constant(world),
		...
		return A2(
			...
			function (_v0) {
				...
				if (actor.$ === 'Minecart') {
					...
					return $elm$core$Maybe$Just(minecart);
				} else {
					return $elm$core$Maybe$Nothing;
				}
			},
		...
		return A2(
			...
			function (item) {
				return A2(
					...
					A2(
						$elm$core$Maybe$andThen,
						$author$project$Data$Minecart$insert(item),
			...
			return _Utils_Tuple3(
				A2(
					...
					A2(
						$elm$core$Maybe$map,
						function (actor) {
							return A3($author$project$Data$World$setActor, id, actor, w);
						},
						A2(
							$elm$core$Maybe$map,
							$author$project$Data$Actor$Minecart,
				...
				if (_v1.$ === 'Just') {
					if (_v1.a.a.$ === 'FloorBlock') {
						...
						return function (_v3) {
							var w = _v3.a;
							var l = _v3.b;
							return _Utils_Tuple3(w, args.forwardPos, l);
						}(
							A3($author$project$Data$Behavior$Minecart$collect, pos, id, world));
					} else {
						var _v4 = _v1.a;
						var entity = _v4.a.a;
						return _Utils_Tuple3(
							...
							function () {
								var _v6 = A2($author$project$Data$World$get, args.backPos, world);
								if ((_v6.$ === 'Just') && (_v6.a.a.$ === 'FloorBlock')) {
									var _v7 = _v6.a;
									return args.backPos;
								} else {
									return pos;
...
var $author$project$Data$Behavior$Minecart$moveOnTrack = F3(
	function (args, _v0, world) {
		...
		var _v1 = A2(
			$elm$core$List$filter,
			function (p) {
				return (!_Utils_eq(p, args.backPos)) && function () {
					var _v2 = A2($author$project$Data$World$get, p, world);
					if (((_v2.$ === 'Just') && (_v2.a.a.$ === 'FloorBlock')) && (_v2.a.a.a.$ === 'Track')) {
						var _v3 = _v2.a;
						var _v4 = _v3.a.a;
						return true;
					} else {
		...
		if (_v1.b && (!_v1.b.b)) {
			...
			return function (_v5) {
				var w = _v5.a;
				var l = _v5.b;
				return _Utils_Tuple3(w, p, l);
			}(
				A3(
					$author$project$Data$Behavior$Minecart$collect,
					pos,
					id,
					A2(
						$elm$core$Maybe$withDefault,
						...
						A2(
							$elm$core$Maybe$map,
							function (actor) {
								return A3($author$project$Data$World$setActor, id, actor, world);
							},
							A2(
								$elm$core$Maybe$map,
								$author$project$Data$Actor$Minecart,
	...
	function (id, _v0, world) {
		...
		return A2(
			...
			function (movedFrom) {
				...
				var positions = {backPos: movedFrom, forwardPos: forwardPos};
				return function (_v1) {
					var world0 = _v1.a;
					var p = _v1.b;
					var effects = _v1.c;
...
var $author$project$Data$World$updateEntity = F3(
	function (pos, fun, world) {
		return _Utils_update(
			world,
			{
				entities: A3($elm$core$Dict$update, pos, fun, world.entities)
			});
	});
var $author$project$Data$Behavior$WaterSource$act = F2(
	function (pos, world) {
		return A3(
			$elm$core$List$foldl,
			function (p) {
				return A2(
					$author$project$Data$World$updateEntity,
					p,
					function (maybe) {
						return $elm$core$Maybe$Just(
							A2($elm$core$Maybe$withDefault, $author$project$Data$Entity$Water, maybe));
					});
			},
			world,
			$author$project$Data$Position$neighbors(pos));
...
var $author$project$Data$Actor$WaterSource = {$: 'WaterSource'};
			...
			switch (caveType.$) {
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Data$World$insertActor(
									$author$project$Data$Actor$Helper(
										$author$project$Data$Actor$Falling($author$project$Data$Item$Coal))))
							]));
				case 'IronCave':
					return A2(
						$elm$random$Random$weighted,
						...
						_List_fromArray(
							[
								...
								$author$project$Data$World$insertActor(
									$author$project$Data$Actor$Helper(
										$author$project$Data$Actor$Falling($author$project$Data$Item$Iron)))),
								_Utils_Tuple2(
								1 / 8,
				...
				case 'WaterCave':
					return A2(
						...
						_Utils_Tuple2(
							1,
							$author$project$Data$World$insertEntity($author$project$Data$Entity$Water)),
						_List_fromArray(
							[
								_Utils_Tuple2(
								1 / 4,
								...
								_Utils_Tuple2(
								1 / 8,
								$author$project$Data$World$insertActor($author$project$Data$Actor$WaterSource))
							]));
				default:
					return A2(
						$elm$random$Random$weighted,
...
var $JohnBugner$elm_bag$Bag$fromAssociationList = A2(
	...
	function (_v0) {
		var v = _v0.a;
		var n = _v0.b;
		return A2($JohnBugner$elm_bag$Bag$insert, n, v);
	},
	$JohnBugner$elm_bag$Bag$empty);
var $author$project$AnyBag$fromAssociationList = F2(
	function (encode, list) {
		return {
			content: $JohnBugner$elm_bag$Bag$fromAssociationList(
				A2(
					$elm$core$List$map,
					$elm$core$Tuple$mapFirst(encode),
					list)),
			encode: encode
		};
	});
				...
				function (stop) {
					return stop ? $elm$random$Random$constant(
						A3(
							$author$project$Data$World$insertActor,
							$author$project$Data$Actor$Minecart(
								$author$project$Data$Minecart$fullWagon($author$project$Data$Item$Coal)),
							pos,
							A3(
								$elm$core$List$foldl,
								function (p) {
...
var $author$project$Data$Excavator$insertItem = F2(
	function (item, excavator) {
		return A2(
			$elm$core$Maybe$map,
			function (storage) {
				return _Utils_update(
			...
			A2($author$project$Data$Storage$insert, item, excavator.storage));
	});
var $author$project$Data$Behavior$Excavator$collect = F2(
	function (_v0, w) {
		var pos = _v0.a;
		var id = _v0.b;
		var e = _v0.c;
							...
							function (excavator) {
								return A2(
									...
									A3(
										$author$project$Data$World$setActor,
										id,
										$author$project$Data$Actor$Excavator(excavator),
										world));
							},
							A2(
								$elm$core$Maybe$andThen,
								function (i) {
									return A2($author$project$Data$Excavator$insertItem, i, e);
								},
								A2($author$project$Data$World$getItem, p, world))));
				}),
			w,
			$author$project$Data$Position$neighbors(pos));
	});
var $author$project$Data$Behavior$Excavator$mine = F2(
	function (pos, world) {
		return A3(
			$elm$core$List$foldl,
			function (p) {
				var _v0 = A2($author$project$Data$World$getBlock, p, world);
				if ((_v0.$ === 'Just') && (_v0.a.$ === 'EntityBlock')) {
					var entity = _v0.a.a;
					if (entity.$ === 'Vein') {
						return $elm$random$Random$andThen(
		...
		A2(
			...
			function (_v0) {
				...
				return _Utils_update(
					excavator,
					{
						hasReversed: !excavator.hasReversed,
						momentum: excavator.hasReversed ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
							_Utils_Tuple2(-x, -y))
					});
			},
			excavator.momentum));
...
var $author$project$Data$Storage$load = F2(
	function (items, storage) {
		return (_Utils_cmp(
			$author$project$AnyBag$size(items) + $author$project$AnyBag$size(storage.items),
			storage.maxAmount) < 1) ? $elm$core$Maybe$Just(
			_Utils_update(
				storage,
				{
					items: A2($author$project$AnyBag$union, items, storage.items)
				})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Data$World$load = F3(
	function (pos, bag, world) {
		return A2(
			$elm$core$Maybe$andThen,
			function (_v0) {
				var id = _v0.a;
				...
				switch (actor.$) {
					case 'Minecart':
						...
						return A2(
							...
							A2($author$project$Data$Storage$load, bag, minecart.storage));
					case 'Train':
						var train = actor.a;
						return $elm$core$Maybe$Just(
							function (a) {
								return A3($author$project$Data$World$setActor, id, a, world);
							}(
								$author$project$Data$Actor$Train(
									A2($author$project$Data$Train$addAll, bag, train))));
					default:
						return $elm$core$Maybe$Nothing;
				}
			},
...
var $author$project$Data$World$unload = F2(
	function (pos, world) {
		return A2(
			$elm$core$Maybe$andThen,
			function (_v0) {
				...
				if (actor.$ === 'Excavator') {
					...
					return $elm$core$Maybe$Just(
						A2(
							...
							$author$project$Data$Storage$unload(excavator.storage)));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			},
	...
	function (args, w) {
		return A2(
			...
			function (_v0) {
				var world = _v0.a;
				var bag = _v0.b;
				return A3($author$project$Data$World$load, args.to, bag, world);
			},
			A2($author$project$Data$World$unload, args.from, w));
	});
var $author$project$Data$Behavior$Excavator$collideWith = F3(
...
var $author$project$Data$Behavior$Excavator$move = F3(
			...
			A2(
				...
				$author$project$Data$Effect$map(
					function (w) {
						return _Utils_Tuple2(
							A2(
								$author$project$Data$Behavior$Excavator$collect,
								_Utils_Tuple3(pos, id, excavator),
								w),
							_List_Nil);
					}),
				A2(
					$elm$core$Maybe$map,
					function (_v1) {
						var newPos = _v1.newPos;
						var block = _v1.block;
						if (block.$ === 'EntityBlock') {
							var entity = block.a;
							return A3(
								$author$project$Data$Behavior$Excavator$collideWith,
								_Utils_Tuple2(newPos, entity),
								_Utils_Tuple3(pos, id, excavator),
								world);
						} else {
					...
					A2(
						$elm$core$Maybe$andThen,
						function (momentum) {
							var newPos = A2($author$project$Data$Position$plus, momentum, pos);
							return A2(
								$elm$core$Maybe$map,
								function (block) {
									return {block: block, newPos: newPos};
								},
								A2($author$project$Data$World$getBlock, newPos, world));
						},
						excavator.momentum))));
	});
...
var $author$project$Data$Behavior$actorsAct = F2(
	function (_v0, game) {
		...
		switch (actor.$) {
			case 'Minecart':
				return $elm$random$Random$constant(
					A2($author$project$Data$Behavior$Minecart$act, id, game));
			case 'Excavator':
				var excavator = actor.a;
				var _v3 = excavator.momentum;
				if (_v3.$ === 'Just') {
					return A2(
						$elm$random$Random$map,
						$elm$core$Tuple$mapFirst(
						...
						A3(
							$author$project$Data$Behavior$Excavator$move,
							_Utils_Tuple2(pos, excavator),
							id,
							game.world));
				} else {
					return $author$project$Data$Effect$withNone(game);
				}
			case 'Bomb':
				return $author$project$Data$Effect$genWithNone(
					A2(
						...
						A2($author$project$Data$Behavior$Bomb$timePassed, id, game.world)));
			case 'Helper':
				var helper = actor.a;
				switch (helper.$) {
					case 'Cave':
					...
					case 'Falling':
						...
						return $author$project$Data$Effect$genWithNone(
							A2(
								...
								A3($author$project$Data$Behavior$FallingCoal$act, item, pos, game.world)));
					default:
						return $author$project$Data$Effect$genWithNone(
							A2(
								$elm$random$Random$map,
								...
								A2($author$project$Data$Behavior$Path$act, pos, game.world)));
				}
			case 'Train':
				return $author$project$Data$Effect$withNone(game);
			default:
				return $author$project$Data$Effect$withNone(
					A2(
						$author$project$Data$Game$setWorldOf,
						game,
						A2($author$project$Data$Behavior$WaterSource$act, pos, game.world)));
		}
	});
		...
		return A2($author$project$Data$World$isFloor, pos, game.world) ? A2(
			...
			A2(
				...
				A3(
					...
					cost,
					item,
					$author$project$Data$Game$getTrain(game)))) : game;
	});
					...
					function (game) {
						...
						function () {
							...
							if (_v1.$ === 'Just') {
								...
								return $author$project$Data$Game$select(pos);
							}
						}()(model.game)),
					$elm$core$Platform$Cmd$none);
			case 'TimePassed':
...
var $author$project$Data$Info$fromActor = function (actor) {
	switch (actor.$) {
		...
		default:
			return $author$project$Data$Info$new(
				{description: 'spawns water around it', title: 'Water Source'});
	}
};
...
var $author$project$Config$excavatorMaxItems = ($author$project$Config$wagonMaxItems / 2) | 0;
														...
														A2(
															...
															_List_fromArray(
																[
																	...
																	args.buildActor,
																	{
																		actor: $author$project$Data$Actor$Excavator($author$project$Data$Excavator$new),
																		cost: _Utils_Tuple2($author$project$Data$Item$Iron, $author$project$Config$excavatorCost)
																	}),
																	A2(
																	$author$project$View$Tab$buildActorButton,
																	args.buildActor,
			...
			A2(
				...
				(level === 1) ? _List_fromArray(
					...
					[
						...
						$Orasund$elm_layout$Layout$heading2,
						_List_Nil,
						$elm$html$Html$text('Hint: Build a minecart')),
						A2(
						$Orasund$elm_layout$Layout$paragraph,
						_List_Nil,
						$elm$html$Html$text('Build a minecart by clicking on an empty floor tile and select \"Build Wagon\"')),
						A2(
						$Orasund$elm_layout$Layout$el,
						$Orasund$elm_layout$Layout$centered,
						A2($author$project$View$Animation$animate, modal.animation, modal.animationFrame)),
