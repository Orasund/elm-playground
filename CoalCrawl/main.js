...
var $author$project$Data$World$get = F2(
	function (pos, world) {
		...
		return A2(
			$elm$core$Maybe$map,
			function (block) {
				return _Utils_Tuple2(block, items);
			},
		...
		if (_v1.$ === 'Just') {
			if (_v1.a.a.$ === 'FloorBlock') {
				...
				if (maybeItem.$ === 'Just') {
					...
					var _v4 = A2($author$project$Data$World$getActorAt, pos, world);
					if (_v4.$ === 'Just') {
						var _v5 = _v4.a;
						var id = _v5.a;
						return $author$project$Data$Minecart$isFull(wagon) ? _Utils_Tuple3(world, args.forwardPos, _List_Nil) : function (_v6) {
							var wag = _v6.a;
							var sound = _v6.b;
							return function (w) {
								...
								A2(
									...
									A3(
										...
										id,
										function (_v7) {
											return $author$project$Data$Actor$Minecart(wag);
										},
										world)));
						}(
				...
				return _Utils_Tuple3(
							...
							return A2(
								...
								A2(
									...
									function (_v10) {
										...
										if (actor.$ === 'Minecart') {
											var w0 = actor.a;
											var _v12 = A2($author$project$Data$World$getActorAt, pos, world);
											if (_v12.$ === 'Just') {
												var _v13 = _v12.a;
												var id = _v13.a;
												return A3(
					...
					function () {
						var _v16 = A2($author$project$Data$World$get, args.backPos, world);
						if ((_v16.$ === 'Just') && (_v16.a.a.$ === 'FloorBlock')) {
							var _v17 = _v16.a;
							return args.backPos;
						} else {
							return pos;
		...
		return function (world) {
			...
			function (p) {
				...
				function () {
					...
					if ((_v0.$ === 'Just') && (_v0.a.a.$ === 'FloorBlock')) {
						var _v1 = _v0.a;
						return forwardPos;
					} else {
						return function (list) {
							...
							A2(
								$elm$core$List$filter,
								function (p) {
									var _v2 = A2($author$project$Data$World$get, p, game.world);
									if ((_v2.$ === 'Just') && (_v2.a.a.$ === 'FloorBlock')) {
										var _v3 = _v2.a;
...
var $author$project$Data$Behavior$Player$putIntoWagon = function (game) {
	...
	if ((_v0.$ === 'Just') && (_v0.a.b.$ === 'Minecart')) {
		...
		return function (_v5) {
			...
			$author$project$Data$Minecart$isFull(wagon) ? _Utils_Tuple2(
				game,
				_List_fromArray(
					[
							...
							return A2(
								...
								function (rand) {
									return (_Utils_cmp(rand, 1 / 3) < 0) ? $elm$random$Random$constant(
										A3($author$project$Data$World$insertActor, $author$project$Data$Actor$Path, p, w)) : A2(
										$elm$random$Random$map,
										function (fun) {
											return A2(fun, p, w);
										},
							...
							A2(
								...
								_List_fromArray(
									[
										...
										1 / 8,
										$elm$random$Random$constant(
											$author$project$Data$World$insertActor($author$project$Data$Actor$Path))),
										_Utils_Tuple2(
										1 / 64,
										$elm$random$Random$constant(
											...
											return $elm$random$Random$andThen(
												function (it) {
													return _Utils_eq(p, nextPos) ? $elm$random$Random$constant(
														A3($author$project$Data$World$insertActor, $author$project$Data$Actor$Mine, p, it)) : A2(
														$elm$random$Random$map,
														function (fun) {
															return A2(fun, p, it);
														},
		...
		return A2(
			...
			A2(
				...
				function (momentum) {
					...
					var _v1 = A2($author$project$Data$World$getBlock, newPos, world);
					if (_v1.$ === 'Just') {
						if (_v1.a.$ === 'EntityBlock') {
							...
							if (entity.$ === 'Vein') {
								return A2(
									...
									A2(
										...
										A2($author$project$Data$World$Generation$mine, newPos, world)));
							} else {
								return $author$project$Data$Effect$withNone(
									A3(
										$author$project$Data$World$updateActor,
							...
							return $author$project$Data$Effect$withNone(
								A3($author$project$Data$World$moveActorTo, newPos, id, world));
						}
					} else {
...
var $author$project$Data$Info$fromActor = function (actor) {
	switch (actor.$) {
		...
		case 'Path':
			return $author$project$Data$Info$new(
				{description: 'Helper Block to generate paths', title: 'Path'});
		case 'Mine':
			return $author$project$Data$Info$new(
			...
			return $author$project$Data$Info$new(
				{
					...
					title: 'Falling ' + $author$project$Data$Item$toString(item)
				});
		case 'Bomb':
...
var $author$project$Data$Excavator$new = {hasReversed: false, momentum: $elm$core$Maybe$Nothing};
