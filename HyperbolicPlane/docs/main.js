...
var $author$project$Chapter$HyperbolicModels$beltramiLines = $author$project$View$Canvas$hyperbolic(
	A2(
		...
		A2(
			$elm$core$List$concatMap,
			$author$project$Hyperbolic$pointsAlongLine(1000),
			A2(
...
var $author$project$Internal$lineIntersection = F2(
	function (equ1, equ2) {
		var det = A2($elm$core$Debug$log, 'det', (equ1.x * equ2.y) - (equ1.y * equ2.x));
...
var $author$project$Chapter$LineSegments$chapter = A2(
	...
	A2(
		...
		$dtwrks$elm_book$ElmBook$Chapter$chapter('Line Segments')));
...
var $author$project$Main$main = A2(
	...
	_List_fromArray(
		[$author$project$Chapter$one, $author$project$Chapter$HyperbolicModels$chapter, $author$project$Chapter$IdealPoints$chapter, $author$project$Chapter$LineSegments$chapter]),
	A2(
